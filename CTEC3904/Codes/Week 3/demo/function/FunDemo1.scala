...
object FunDemo1 {
  ...
  val cube: Int => Int = x => math.pow(x, 3).intValue
  ...
  val flipSub: Int => Int => Int = x => y => sub(y)(x)
//  val smaller: Int => Int => Int = itShould("return the smaller of the two arguments")
//  val larger: Int => Int => Int = itShould("return the larger of the two arguments")
//  val balance: Int => Int => Int = itShould("return -1 if 1st arg < 2nd arg; 0 if equal; 1 if 1st arg > 2nd arg")
//  val gcd: Int => Int => Int = itShould("return the greatest common divisor of its arguments")
  // only consider positive integer arguments
//  val lcm: Int => Int => Int = itShould("return the lowest common multiple of its arguments")
  // only consider positive integer arguments
...
//  val quadruple: Int => Int = itShould("quadruple its argument")
//  val pwr4: Int => Int = itShould("raise its argument to the fourth power")
//  val oneTenthAfterSub2: Int => Int = itShould("reduce its argument by two and then return one tenth of the result")
//  val threeQuarters: Int => Int = itShould("return 3/4 of its argument")
  // threeQuarters should do the multiplication first to improve accuracy (due to integer division)
//  val bound: Int => Int => Int => Int = itShould("return the 3rd arg bounded by the first two args")
  // Thus bound(1)(100)(-5) = 1;  bound(64)(32)(99) = 64;  bound(10)(20)(15) = 15;  etc.
  // smaller(greater(a)(b))(greater(smaller(a)(b))(c))
...
//  val thrice: (Int => Int) => (Int => Int) = itShould("apply its 1st arg three times to its 2nd arg: i.e. f(f(f(x)))")
//  val thrice2: (Int => Int) => (Int => Int) = itShould("behave like thrice but be defined in a similar way to twice2")
//  val octo: (Int => Int) => (Int => Int) = itShould("apply its 1st arg eight times to its 2nd arg")
//  val octo2: (Int => Int) => (Int => Int) = itShould("behave like octonary but be defined using composition")
  /*
   * Consider the following function:
   */
