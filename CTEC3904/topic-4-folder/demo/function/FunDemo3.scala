...
object FunDemo3 {
   ...
   * DESCENDING ORDER.
   */
  def descending(lo: Int, hi: Int): Unit = itShould("output the values lo-hi in descending order")
   ...
   */
  def sumOdds(a: Int, b: Int): Int = itShould("return the sum of the odd numbers between a and b inclusive")
   ...
   */
  def sumFromTo(a: Int, b: Int): Int = itShould("return the sum of the numbers from a to b (inclusive)")
  /*
   ...
   */
  def isPrime2(n: Int): Boolean = itShould("behave like isPrime but be implemented recursively")
